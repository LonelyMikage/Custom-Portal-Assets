...
| Light_rail_corner.vtf | enby rail texture |
| Light_rail_endcap.vtf | enby rail texture |
| Light_rail_endcap_glass.vtf | enby rail texture |
| Light_rail_wall_emitter.vtf | enby rail texture |
...
| props_junk | descriptions |
| --- | --- |
| garbage003a_01.vtf | trans mug |

**^ Located in hl2\materials\models ^**

**weapons**
> v_models
> | transparent gun [cosine] | descriptions |
> | --- | --- |
...
### Signage
| indicator_lights | descriptions |
| --- | --- |
| indicator_lights_corner_floor.vtf | trans power lights |
| indicator_lights_corner_floor001.vtf | trans power lights |
| indicator_lights_corner_wall.vtf | trans power lights |
| indicator_lights_floor.vtf | trans power lights |
| indicator_lights_wall.vtf | trans power lights |

| other | descriptions |
| --- | --- |
| overlay_aperture_logo_worn.vtf | Source Done Proud Logo |
| signage_arrow.vtf | rainbow arrow|
| signage_doorstate.vtf | power indicator face |
| signage_exit.vtf | Rippy exit sign |
| signage_overlay_arrow.vtf | same thing as signage_arrow |
...
| signage_overlay_dots1.vtf | rainbow dots |
| signage_overlay_dots2.vtf | rainbow dots |
| signage_overlay_dots3.vtf | rainbow dots |
| signage_overlay_dots4.vtf | rainbow dots |
